            ...
            if (count($arrayNotProcessed) > 0) {
                ...
                foreach ($arrayNotProcessed as $rowNotProcessed) {
                    ...
                    if($rowNotProcessed->id_tipo_pago==$Constans['PAGO_CON_AYDEN'] ):
                     ...
                     if($rowNotProcessed->id_tipo_pago==$Constans['PAGO_CON_REGALA_PIZZA'] ):
                       $ventamaxx_tipo_orden=16;
                    endif;
                    ...
                    $arrayAddressClient['domicilio_cliente']=$this->strip_tildes(stripslashes($arr_tmp_client[0]->domicilio_cliente));
                    ...
                    $arrayAddressClient['referencia_domicilio_cliente']=$this->strip_tildes(stripslashes($arr_tmp_client[0]->referencia_domicilio_cliente));
                    $arrayAddressClient['colonia_garantia_ube']='';    
                    $arrayAddressClient['app_colonias_garantia_ube']=$this->strip_tildes(stripslashes($arr_tmp_client[0]->app_colonias_garantia_ube)); 
                   ...
                   // $msgGarantia = ($arr_name_client[0]->id_status_garantia_ube == $Constans['STATUS_CON_GARANTIA']) ? 'T30' : '';
                    ...
                    $json_arr['orden'][$cont_orden]['comentario'] = trim($arrayAddress['msgGarantia'] . ' ' . $rowNotProcessed->comentario_orden_pedido . ' ' . $msn);
                    ...
                    $json_arr['orden'][$cont_orden]['cliente']['referencia_domicilio'] = trim(addslashes($this->strip_tildes(stripcslashes(trim($arrayAddress['referencia_domicilio_cliente'])))));
                    ...
                    if (count($arrayProducts) > 0) {
                       // dd($arrayProducts);
                        foreach ($arrayProducts as $rowProduct) {
                            ...
                            $precio_paquete = $rowProduct->precio_dsc_articulo_pedido;
                            ...
                            if ($categoryProduct[0]->id_categoria == $Constans['ESPECIALIDADES'] || $categoryProduct[0]->id_categoria == $Constans['PIZZAS']) {
                                ...
                                if (Store::getStatusTaxStore($data) > 0):
                                    //calculos para el cobro del iva..
                                    $cant_sin_iva = ($rowProduct->precio_dsc_articulo_pedido / 1.16);
                                    $cant_iva_round = ($cant_sin_iva * 100) / 100;
                                    //desgloce..
                                    $iva_float = $cant_iva_round * 0.16;
                                    $iva = ($iva_float * 100) / 100;
                                ...
                                if ($rowProduct->ban_aplica_codigo_promocion_orden_pedido == $Constans['VIGENTE']) {
                                    ...
                                    /**/
                                    $precio_paquete = $rowProduct->precio_dsc_articulo_pedido;
                                    $precio_dm_paquete = $rowProduct->precio_dsc_articulo_pedido;
                                    ...
                                    if (count($arrayDiscount) > 0) {
                                        ...
                                        //$precio_promocion_articulo=$clOnline->precio_dsc_articulo_pedido;
                                        $precio_paquete = $rowProduct->precio_dsc_articulo_pedido - $arrayDiscount[0]->monto_descuento_procesado_orden_codigo_promocion;
                                        $descuento_paquete = $rowProduct->precio_dsc_articulo_pedido - $precio_paquete;
                                        $precio_producto = $rowProduct->precio_dsc_articulo_pedido;
                                ...
                                if ($rowProduct->app_porcion_armado_pizza == 8) {
                                ...
                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['comment_producto'] = '';
                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['descripcion_producto'] = $rowProduct->web_descripcion_tamano_articulo . ' ' . $rowProduct->web_nombre_articulo;
                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['precio_producto'] = $rowProduct->precio_dsc_articulo_pedido . '.00';
                                   ...
                                   //  dd($rowProduct);
                                    ...
                                    if ($rowProduct->app_porcion_armado_pizza == 8) {
                                        ...
                                        for ($i = 0; $i <= 7; $i++) {
                                            ...
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $reseta_base;
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'SALSA';
                                            $id_porcion++;
                                        }
                                        $cont_recetas_baseOct++;
                                        ...
                                        if ($receta_especialidad > 0) {
                                            if ($rowProduct->app_porcion_armado_pizza == 8) {
                                                ...
                                                for ($i = 0; $i <= 7; $i++) {
                                                    ...
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $receta_especialidad;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = $rowProduct->nombre_articulo;
                                                    $id_porcion++;
                                                }
                                                $cont_recetas_baseOct++;
                                            }
                                    ...
                                    if ($arrayPizzaBuilder[0]->extra_chesse == 1):
                                         ...
                                         if ($rowProduct->app_porcion_armado_pizza == 8) {
                                            ...
                                            for ($i = 0; $i <= 7; $i++) {
                                                ...
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $reseta_extra_queso;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = $cont_receta_queso;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'Con extraqueso';
                                                $id_porcion++;
                                            }
                                            $cont_recetas_baseOct++;
                                        }
                                    ...
                                    if ($arrayPizzaBuilder[0]->borde < 0):
                                        if ($rowProduct->app_porcion_armado_pizza == 8) {
                                            ...
                                            for ($i = 0; $i <= 7; $i++) {
                                                ...
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $Constans['RECETA_AJOJOLI'];
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = -1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'Sin ajojolí';
                                                $id_porcion++;
                                            }
                                            $cont_recetas_baseOct++;
                                        } 
                                    ...
                                    if ($arrayPizzaBuilder[0]->borde == 2): //CON AJONJOLI NEGRO
                                        if ($rowProduct->app_porcion_armado_pizza == 8) {
                                            $id_porcion = 7;
                                            for ($i = 0; $i <= 7; $i++) {

                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $Constans['RECETA_AJOJOLI_NEGRO'];
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'Con ajonjolí negro';
                                                $id_porcion++;
                                            }
                                            $cont_recetas_baseOct++;
                                        }
                                        ...
                                        if ($rowProduct->app_porcion_armado_pizza == 4) {
                                            ...
                                            for ($i = 0; $i <= 3; $i++) {
                                                ...
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['id_receta'] = $Constans['RECETA_AJOJOLI_NEGRO'];
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['descripcion_receta'] = 'Con ajonjolí negro';
                                                $id_porcion++;
                                            }
                                            $cont_recetas_base4x4++;
                                        } else{

                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['id_receta'] = $Constans['RECETA_AJOJOLI_NEGRO'];
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['cantidad_receta'] = 1;
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['descripcion_receta'] = 'Con ajonjolí negro';
                                    ...
                                    if ($arrayPizzaBuilder[0]->orilla_queso >= $Constans['CON_ORILLA']):
                                        ...
                                        //ORILLA QUESO DE SABORES..
                                        $dataBorder['id_tipo_orilla_queso']=$arrayPizzaBuilder[0]->orilla_queso;
                                        $arrayBorder=Ingredient::getChesseBorderItemByParam($dataBorder);
                                        if(!empty($arrayBorder) && count($arrayBorder)>0){
                                            $receta_orilla=$arrayBorder[0]->id_receta_ventamaxx;
                                            $descripcion_receta_orilla=$arrayBorder[0]->descripcion_tipo_orilla_queso;
                                        }
                                        else{
                                            $receta_orilla=$Constans['RECETA_ORILLA_QUESO'];
                                            $descripcion_receta_orilla='Orilla de queso';
                                        }
                                        //FIN ORILLA QUESO SABORES..
                                         if ($rowProduct->app_porcion_armado_pizza == 8) {
                                            $id_porcion = 7;
                                            for ($i = 0; $i <= 7; $i++) {
                                                
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $receta_orilla;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = $descripcion_receta_orilla;
                                        ...
                                        if ($rowProduct->app_porcion_armado_pizza == 4) {
                                            ...
                                            for ($i = 0; $i <= 3; $i++) {
                                                ...
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['id_receta'] = $receta_orilla;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['descripcion_receta'] = $descripcion_receta_orilla;
                                            ...
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['id_receta'] = $receta_orilla;
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['cantidad_receta'] = 1;
                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['descripcion_receta'] = $descripcion_receta_orilla;
                                            $cont_recetas_full++;
                                        }
                                    ...
                                    if ($arrayPizzaBuilder[0]->pan_cruji == $Constans['CON_PANCRUJI']):
                                         if ($rowProduct->app_porcion_armado_pizza == 8) {
                                            ...
                                            for ($i = 0; $i <= 7; $i++) {
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $Constans['RECETA_PAN_CRUJI'];
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'Pan cruji';
                                    ...
                                    if ($arrayPizzaBuilder[0]->ban_cuartos_esp > 0 || $rowProduct->app_porcion_armado_pizza == 4) {
                                        ...
                                        /* aqui cuartos.. */
                                            ...
                                            /*OCTAVOS*/
                                            $cont_recetas_oct1=$cont_recetas_baseOct;
                                            $cont_recetas_oct2=$cont_recetas_baseOct;
                                            $cont_recetas_oct3=$cont_recetas_baseOct;
                                            $cont_recetas_oct4=$cont_recetas_baseOct;
                                            $cont_recetas_oct5=$cont_recetas_baseOct;
                                            $cont_recetas_oct6=$cont_recetas_baseOct;
                                            $cont_recetas_oct7=$cont_recetas_baseOct;
                                            $cont_recetas_oct8=$cont_recetas_baseOct;
                                            /*OCTAVOS*/
                                            if ($arrayPizzaBuilder[0]->id_esp_oct1_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['id_porcion'] = 7;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct1_builder)->get();
                                                ...
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct1++;                                                
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct2_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['id_porcion'] = 8;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct2_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct2++;
                                              
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct3_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['id_porcion'] = 9;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct3_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct3++;
                                              
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct4_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['id_porcion'] = 10;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct4_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_oct4]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_oct4]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_oct4]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct4++;
                                              
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct5_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['id_porcion'] = 11;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct5_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct5++;
                                              
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct6_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['id_porcion'] = 12;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct6_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct6++;
                                              
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct7_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['id_porcion'] = 13;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct7_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['descripcion_receta'] = $nombre_ingrediente;

                                                $cont_recetas_oct7++;
                                              
                                            }
                                            
                                            if ($arrayPizzaBuilder[0]->id_esp_oct8_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['id_porcion'] = 14;
                                                };

                                                $arrayRecipe = Product::where('id_articulo', $arrayPizzaBuilder[0]->id_esp_oct8_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;

                                                //$id_receta_ventamaxx = $clOnline->get_receta_vmx_by_id_articulo($clOnline->id_esp_left_builder);
                                                // $nombre_ingrediente = $clOnline->get_nombre_articulo_by_parameter($clOnline->id_esp_left_builder);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct8]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct8]['cantidad_receta'] = 1;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct8]['descripcion_receta'] = $nombre_ingrediente;
                                    ...
                                    if ($procesado_aplica_desc_articulo_pedido_aux == 1):
                                        ...
                                        //$json_arr['orden'][$cont_orden]['productos'][$cont_producto]['preciodm_producto'] = $clOnline->precio_dsc_articulo_pedido;
                                    ...
                                    if ($procesado_aplica_desc_articulo_pedido_aux == 3):
                                        ...
                                        elseif ($rowProduct->cantidad_articulo_pedido > 1) :
                                            ...
                                            $descuento_paquete = round($rowProduct->precio_dsc_articulo_pedido / $rowProduct->cantidad_articulo_pedido);
                                            $precio_producto = $rowProduct->precio_dsc_articulo_pedido;
                                            $precio_dm_paquete = $precio_producto - $descuento_paquete;

                                            $precio_paquete = $rowProduct->precio_dsc_articulo_pedido - $descuento_paquete;
                                       ...
                                       // dd($arrayCnfPizza);
                                        foreach ($arrayCnfPizza as $rowConfPizza) {
                                            ...
                                            if(count($arrayIngredient)){
                                                ...
                                                //OCTAVOS
                                                if ($arrayPizzaBuilder[0]->ban_octavos_esp > 0 || $rowProduct->app_porcion_armado_pizza == 8) {

                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct1') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct1++;
                                                    } else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct2') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct2++;
                                                    } else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct3') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct3++;
                                                    } else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct4') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_oct4]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_oct4]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_oct4]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct4++;
                                                    }else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct5') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct5++;
                                                    }else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct6') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct6++;
                                                    }else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct7') {
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['descripcion_receta'] = $nombre_ingrediente;

                                                        $cont_recetas_oct7++;
                                                    }else
                                                    if ($rowConfPizza->porcion_ingrediente_pizza == 'oct8') {

                                                        if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7])) {
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['id_porcion'] = 14;
                                                        }

                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct7]['id_receta'] = $id_receta_ventamaxx;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct7]['cantidad_receta'] = $rowConfPizza->cantidad_ingrediente_pizza;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct7]['descripcion_receta'] = $nombre_ingrediente;
                            ...
                            if ($categoryProduct[0]->id_categoria == $Constans['PAQUETES'] || $categoryProduct[0]->id_categoria == $Constans['PAQUETES_LEALTAD'] || $procesado_aplica_desc_articulo_pedido_aux) {
                                ...
                                if ($categoryProduct[0]->id_categoria_promocion == $Constans['PRODUCTOS_VARIOS'] ||
                                    ...
                                    foreach ($arrayConfigPackage as $rowConfPackage) {
                                        ...
                                        $dataProduct['id_unidad'] = $Constans['UNIDAD_MENU_REPARTO'];
                                        $arrayProduct = Product::getProductPricePerStore($dataProduct);                                    
                                      ...
                                      // dd($dataProduct);
                                        ...
                                        if($rowConfPackage->id_articulo==$Constans['PIZZA_BASE_ESP']){
                                             ...
                                             //cambio el total precio lista..
                                              $totalPrecioLista+=$arrayProduct[0]->precio_articulo_tamano * $cant_pedido;
                                             //cambio descuento..
                                              $descuento_paquete = $totalPrecioLista - $precio_paquete; 
                                        }
                                       //  var_dump($totalPrecioLista);
                                     ...
                                     //  dd($rowConfPackage);
                                        ...
                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['comment_producto'] = ' ';
                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['descripcion_producto'] = $rowConfPackage->web_descripcion_tamano_articulo . ' ' . $rowConfPackage->web_nombre_articulo;
                                        ...
                                        if ($categoryItem[0]->ban_descuento_paquete_categoria == 1) {
                                           ...
                                           //---
                                            ...
                                            if ($categoryItem[0]->receta_base_ventamaxx > 0) {
                                                ...
                                                if ($rowConfPackage->app_porcion_armado_pizza == 8) {
                                                    $id_porcion = 7;
                                                    for ($i = 0; $i <= 7; $i++) {
                                            ...
                                            if ($rowConfPackage->id_categoria == $Constans['ESPECIALIDADES'] || $rowConfPackage->id_categoria == $Constans['PIZZAS']) {
                                                ...
                                                if ($arrayBuilder[0]->orilla_queso >= $Constans['CON_ORILLA']) {
                                                    ...
                                                    $dataPrice['id_tamano_articulo'] = $rowConfPackage->id_tamano_articulo;
                                                    $arrayPrice = Product::getPriceExtrasByParams($dataPrice);
                                                    //CALCULAR PRECIO ORILLA Y RECETA..
                                                    $dataBorder['id_tipo_orilla_queso']=$arrayBuilder[0]->orilla_queso;
                                                    $arrayBorder=Ingredient::getChesseBorderItemByParam($dataBorder);
                                                    if(!empty($arrayBorder) && count($arrayBorder)>0){
                                                        $receta_orilla=$arrayBorder[0]->id_receta_ventamaxx;
                                                        $descripcion_receta_orilla=$arrayBorder[0]->descripcion_tipo_orilla_queso;
                                                ...
                                                if ($arrayBuilder[0]->borde == 2): //borde ajonjoli negro
                                                    // $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][]['id_porcion']=0; 
                                                    if ($rowConfPackage->app_porcion_armado_pizza == 8) {
                                                        $id_porcion = 7;
                                                        for ($i = 0; $i <= 7; $i++) {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $Constans['RECETA_AJOJOLI_NEGRO'];
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'Con ajojolí negro';
                                                    ...
                                                    if ($rowConfPackage->app_porcion_armado_pizza == 4) {
                                                        ...
                                                        for ($i = 0; $i <= 3; $i++) {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['id_receta'] = $Constans['RECETA_AJOJOLI_NEGRO'];
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['cantidad_receta'] = 1;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_base4x4]['descripcion_receta'] = 'Con ajojolí negro';
                                                        ...
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['id_receta'] = $Constans['RECETA_AJOJOLI_NEGRO'];
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['cantidad_receta'] = 1;
                                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['descripcion_receta'] = 'Con ajojolí negro';
                                                ...
                                                if ($rowConfPackage->id_articulo == $Constans['PIZZA_BASE'] || $rowConfPackage->id_articulo = $Constans['PIZZA_BASE_ESP']) {
                                                    ...
                                                    //octavos
                                                    $cont_recetas_oct1 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct2 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct3 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct4 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct5 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct6 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct7 = $cont_recetas_baseOct+1; //return the last position of base recipe
                                                    $cont_recetas_oct8 = $cont_recetas_baseOct+1; //return the last position of base recipe

                                                    
                                                    
                                                    if ($arrayBuilder[0]->ban_octavos_esp > 0 || $rowConfPackage->app_porcion_armado_pizza == 8) {
                                                       // var_dump($rowConfPackage);
                                                        if ($arrayBuilder[0]->id_esp_oct1_builder > 0) {
                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['id_porcion'] = 7;
                                                            }
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct2_builder > 0) {
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct3_builder > 0) {
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct4_builder > 0) {

                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['id_porcion'] = 10;
                                                            }

                                                            $arrayRecipe = Product::where('id_articulo', $arrayBuilder[0]->id_esp_oct4_builder)->get();
                                                            $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                            $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct5_builder > 0) {

                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['id_porcion'] = 11;
                                                            }

                                                            $arrayRecipe = Product::where('id_articulo', $arrayBuilder[0]->id_esp_oct5_builder)->get();
                                                            $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                            $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct6_builder > 0) {

                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['id_porcion'] = 12;
                                                            }

                                                            $arrayRecipe = Product::where('id_articulo', $arrayBuilder[0]->id_esp_oct6_builder)->get();
                                                            $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                            $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct7_builder > 0) {

                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['id_porcion'] = 13;
                                                            }

                                                            $arrayRecipe = Product::where('id_articulo', $arrayBuilder[0]->id_esp_oct7_builder)->get();
                                                            $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                            $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                                        ...
                                                        if ($arrayBuilder[0]->id_esp_oct8_builder > 0) {

                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['id_porcion'] = 14;
                                                            }

                                                            $arrayRecipe = Product::where('id_articulo', $arrayBuilder[0]->id_esp_oct8_builder)->get();
                                                            $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                            $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                   ...
                                   // dd($rowProduct->id_articulo) 170..;
                                    foreach ($arrayConfigPromo2x1 as $Row){
                                        if ($Row->id_articulo == $Constans['PIZZA_BASE_ESP']) {
                                            ...
                                            $dataProduct['id_unidad'] = $Constans['UNIDAD_MENU_REPARTO'];
                                           // $arrayProductTemp = Product::getProductPrice($dataProduct);
                                            $arrayProductTemp = Product::getProductPricePerStore($dataProduct);
                                    ...
                                    foreach ($arrayConfigPromo2x1 as $RowPromo) {
                                        ...
                                        //dd($RowPromo);
                                        $dataProduct['id_articulo'] = $rowProduct->id_articulo;
                                        $dataProduct['id_tamano_articulo'] = $Row->id_tamano_articulo;
                                        $dataProduct['id_unidad'] = $Constans['UNIDAD_MENU_REPARTO'];
                                        //$arrayProductTemp = Product::getProductPrice($dataProduct);
                                        $arrayProductTemp = Product::getProductPricePerStore($dataProduct);
                                        $precio_articulo_tamano = $arrayProductTemp[0]->precio_articulo_tamano;
                                         //dd($precio_articulo_tamano);
                                        ...
                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['comment_producto'] = ' ';
                                        $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['descripcion_producto'] = $RowPromo->web_descripcion_tamano_articulo . ' ' . $RowPromo->web_nombre_articulo;
                                        ...
                                        //inicializo receta base 8
                                        $cont_recetas_base4x4=0;
                                        if ($RowPromo->app_porcion_armado_pizza == 8) {
                                            $id_porcion = 7;
                                            for ($i = 0; $i <= 7; $i++) {
                                        ...
                                        if ($arrayPktBuilder[0]->extra_chesse == 1): //extraquese
                                            ...
                                            if ($RowPromo->app_porcion_armado_pizza == 8) {
                                                ...
                                                for ($i = 0; $i <= 7; $i++) {
                                                    ...
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $Constans['RECETA_QUESO'];
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = 1;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = 'Con extraqueso';
                                                    $id_porcion++;
                                                }
                                        ...
                                        if ($arrayPktBuilder[0]->orilla_queso >= $Constans['CON_ORILLA']):
                                            ...
                                            //CALCULAR PRECIO ORILLA Y RECETA..
                                            $dataBorder['id_tipo_orilla_queso'] = $arrayPktBuilder[0]->orilla_queso;
                                            $arrayBorder = Ingredient::getChesseBorderItemByParam($dataBorder);
                                            if (!empty($arrayBorder) && count($arrayBorder) > 0) {
                                                $receta_orilla = $arrayBorder[0]->id_receta_ventamaxx;
                                                $descripcion_receta_orilla = $arrayBorder[0]->descripcion_tipo_orilla_queso;
                                        ...
                                        if ($arrayPktBuilder[0]->ban_octavos_esp > 0 || $RowPromo->app_porcion_armado_pizza == 8) {
                                            ...
                                            if ($arrayPktBuilder[0]->id_esp_oct1_builder > 0) {
                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['id_porcion'] = 7;
                                                }

                                                $arrayRecipe = Product::where('id_articulo', $arrayPktBuilder[0]->id_esp_oct1_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['id_receta'] = $id_receta_ventamaxx;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['cantidad_receta'] = 1;
                                            ...
                                            if ($arrayPktBuilder[0]->id_esp_oct2_builder > 0) {

                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['id_porcion'] = 8;
                                                }

                                                $arrayRecipe = Product::where('id_articulo', $arrayPktBuilder[0]->id_esp_oct2_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                            ...
                                            if ($arrayPktBuilder[0]->id_esp_oct3_builder > 0) {

                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['id_porcion'] = 9;
                                                }

                                                $arrayRecipe = Product::where('id_articulo', $arrayPktBuilder[0]->id_esp_oct3_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                            ...
                                            if ($arrayPktBuilder[0]->id_esp_oct4_builder > 0) {

                                                if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3])) {
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['id_porcion'] = 10;
                                                }

                                                $arrayRecipe = Product::where('id_articulo', $arrayPktBuilder[0]->id_esp_oct4_builder)->get();
                                                $id_receta_ventamaxx = $arrayRecipe[0]->id_art_receta_ventamaxx;
                                                $nombre_ingrediente = $arrayRecipe[0]->web_nombre_articulo;
                                             ...
                                             if ($arrayPktBuilder[0]->id_esp_oct5_builder > 0) {
                                             ...
                                             if ($arrayPktBuilder[0]->id_esp_oct6_builder > 0) {
                                            ...
                                            if ($arrayPktBuilder[0]->id_esp_oct7_builder > 0) {
                                            ...
                                            if ($arrayPktBuilder[0]->id_esp_oct8_builder > 0) {
                                        ...
                                        if (($RowPromo->id_articulo == $Constans['PIZZA_BASE'] || $RowPromo->id_articulo == $Constans['PIZZA_BASE_ESP']) ) {
                                            ...
                                            if (count($arrayConfigPizza) > 0) {
                                                ...
                                                foreach ($arrayConfigPizza as $RowConfigItem) {
                                                    ...
                                                    if ($arrayPktBuilder[0]->ban_octavos_esp > 0 || $RowPromo->app_porcion_armado_pizza == 8) {
                                                        ...
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct1') {
                                                            //CHECAR SI EXISTE id_porcion
                                                            if (!@array_key_exists('id_porcion', $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0])) {
                                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['id_porcion'] = 7;
                                                            }
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_oct1]['descripcion_receta'] = $nombre_ingrediente;

                                                            $cont_recetas_oct1++;
                                                        } else
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct2') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][1]['recetas'][$cont_recetas_oct2]['descripcion_receta'] = $nombre_ingrediente;

                                                            $cont_recetas_oct2++;
                                                        } else
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct3') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][2]['recetas'][$cont_recetas_oct3]['descripcion_receta'] = $nombre_ingrediente;

                                                            $cont_recetas_oct3++;
                                                        } else
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct4') {
                                                        ...
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct5') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][4]['recetas'][$cont_recetas_oct5]['descripcion_receta'] = $nombre_ingrediente;

                                                            $cont_recetas_oct5++;
                                                        }
                                                        else
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct6') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][5]['recetas'][$cont_recetas_oct6]['descripcion_receta'] = $nombre_ingrediente;

                                                            $cont_recetas_oct6++;
                                                        }
                                                        else
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct7') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][6]['recetas'][$cont_recetas_oct7]['descripcion_receta'] = $nombre_ingrediente;

                                                            $cont_recetas_oct7++;
                                                        }
                                                        else
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'oct8') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct8]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct8]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][7]['recetas'][$cont_recetas_oct8]['descripcion_receta'] = $nombre_ingrediente;
                                                    ...
                                                    if ($arrayPktBuilder[0]->ban_cuartos_esp > 0 || $RowPromo->app_porcion_armado_pizza == 4) {
                                                        ...
                                                        if ($RowConfigItem->porcion_ingrediente_pizza == 'right4x4') {
                                                            ...
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_right4x4]['id_receta'] = $id_receta_ventamaxx;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_right4x4]['cantidad_receta'] = $RowConfigItem->cantidad_ingrediente_pizza;
                                                            $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][3]['recetas'][$cont_recetas_right4x4]['descripcion_receta'] = $nombre_ingrediente;
                                            ...
                                            if ($arrayPktBuilder[0]->ban_octavos_esp > 0 || $RowPromo->app_porcion_armado_pizza == 8) {
                                                ...
                                                for ($i = 0; $i <= 7; $i++) {
                                                    ...
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['id_porcion'] = $id_porcion;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['id_receta'] = $RowPromo->config_paquete_id_receta_ventamaxx;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['cantidad_receta'] = $RowPromo->cantidad_articulo;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][$i]['recetas'][$cont_recetas_baseOct]['descripcion_receta'] = $RowPromo->web_nombre_articulo;
                                                    $id_porcion++;
                                                }
                                                $cont_recetas_baseOct++;
                                            } 
                                    ...
                                    if ($categoryProduct[0]->id_categoria_promocion == $Constans['DESCUENTO_DIVIDIDO_ENTRE_PRODUCTOS']) {
                                       ...
                                       // $descuento_paquete = $totalPrecioLista - ($precio_paquete / count($arrayConfigPackage));
                                        $descuento_paquete = $totalPrecioLista - $precio_paquete;
                                        $descuento_paquete=$descuento_paquete/count($arrayConfigPackage);
                                      //  dd($descuento_paquete);
                                        ...
                                        foreach ($arrayConfigPackage as $rowConfPackage) {
                                                ...
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['cantidad_producto'] = $rowConfPackage->cantidad_articulo*$cant_pedido;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['comment_producto'] = ' ';
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['descripcion_producto'] = $rowConfPackage->web_descripcion_tamano_articulo . ' ' . $rowConfPackage->web_nombre_articulo;

                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['precio_producto'] =  number_format($precio_dm_paquete, 2);
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['preciodm_producto'] = $precio_dm_paquete;
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['id_esquemacobro'] = $rowConfPackage->config_id_esquema_cobro_ventamaxx; //ocupo el esquema cobro de cada paquete..
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['esquemacobro_producto'] = $nombre_paquete; //descripcion del paquete..
                                                $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['impuesto_producto'] = $iva;
                                                ...
                                                if ($rowConfPackage->id_categoria == $Constans['ESPECIALIDADES'] || $rowConfPackage->id_categoria == $Constans['PIZZAS']) {
                                                    ...
                                                    $dataBuilder['id_procesado_articulo_pedido'] = $rowConfPackage->id_procesado_articulo_pedido;
                                                    $dataBuilder['id_procesado_orden_pizza_builder'] = $rowConfPackage->id_procesado_articulo_pedido;
                                                    $arrayBuilder = Processor::getConfigBuilderByParams($dataBuilder);
                                                   // dd($rowConfPackage->id_articulo);
                                                    $reseta_base = ($arrayBuilder[0]->salsa == 1) ? $Constans['RECETA_BARBECUE'] : $Constans['RECETA_SAPRE'];
                                                    ...
                                                    //METO ESP
                                                    $arraySpeciality = Product::where('id_articulo', $rowConfPackage->id_articulo)->get();
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['id_receta'] = $arraySpeciality[0]->id_art_receta_ventamaxx;
                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['cantidad_receta'] = 1;

                                                    $json_arr['orden'][$cont_orden]['productos'][$cont_producto]['porcion'][0]['recetas'][$cont_recetas_full]['descripcion_receta'] = $arraySpeciality[0]->web_nombre_articulo;
                                                    $cont_recetas_full++; //AHORA SI LA VARIABLE NORMAL
    ...
    public function getAddressClientDeliver($arr_order) {
        ...
        if($arr_order['id_tipo_orden']==$Constans['ID_MOSTRADOR'] ){
            ...
            if ($arr_order['id_rel_domicilio_cliente'] > 0) {
                ...
                if(count($arr_address) && $arr_address[0]->id_colonias_garantia_ube>0){
                    ...
                    //si trae -1
                    $dataAddress['domicilio_cliente'] = @(strlen(trim($arr_address[0]->domicilio_cliente))>0)?trim($arr_address[0]->domicilio_cliente):'';
                    $dataAddress['numero_ext_cliente'] = @(!empty($arr_address[0]->numero_ext_cliente))?$arr_address[0]->numero_ext_cliente:'';
                    $dataAddress['numero_int_cliente'] = @(!empty(trim($arr_address[0]->numero_int_cliente)))?trim($arr_address[0]->numero_int_cliente):'';
                    $dataAddress['app_colonias_garantia_ube'] = @(!empty(trim($arr_address[0]->app_colonias_garantia_ube)))?trim($arr_address[0]->app_colonias_garantia_ube):'';
                    ...
                    if (@strlen(trim($arr_address[0]->celular_cliente)) > 0) {
                        ...
                        $telefono = (!empty($arr_address[0]->lada_cliente) && !empty($arr_address[0]->telefono_cliente))?$arr_address[0]->telefono_cliente:'N/A';
                    }
